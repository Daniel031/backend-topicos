...
<div class="denuncias">
  <a class="btn btn-warning" href="{{route('administrativos.create')}}">Crear</a>
</div>
      ...
      <tr>
        ...
        <td >
          <form action="{{route('administrativos.destroy',$user)}}" method="POST">
            @method('DELETE')
            @csrf
            <a href="{{route('administrativos.edit',$user)}}" class="btn btn-primary"><i class="fa fa-edit">&nbsp;</i></a>
            <a href="{{route('administrativos.show',$user)}}" class="btn btn-info"><i class="fa fa-eye">&nbsp;</i></a>
